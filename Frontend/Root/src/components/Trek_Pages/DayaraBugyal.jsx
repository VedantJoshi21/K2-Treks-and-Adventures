...
// Import images
import dayaraHero from '../../assets/dayara_hero.png';
import dayaraTrek from '../../assets/dayara_trek.png';
import dayaraMeadows from '../../assets/dayara_meadows.png';

export default function DayaraBugyal({ darkMode, setDarkMode, theme }) {
    ...
    <>
      ...
      <section style={{ position: 'relative', height: '90vh', width: '100%' }}>
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', overflow: 'hidden' }}>
          <div style={{
            ...
            backgroundImage: `url(${dayaraHero})`,
        ...
        <div style={{
          ...
          <h1 style={{
            ...
            Dayara Bugyal Trek - The Endless Meadows
          </h1>
          <p style={{
            fontSize: 'clamp(1rem, 2vw, 1.25rem)', opacity: 0.9, maxWidth: '700px',
            lineHeight: 1.6, marginBottom: '2.5rem',
          }}>
            Walk into an endless carpet of high-altitude meadows. A spectacular journey through vibrant forests to the crown of the Garhwal Himalayas.
          </p>
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              { label: 'MAX ALTITUDE', value: '12,300 ft', icon: <ArrowUpDown size={22} /> },
              { label: 'DIFFICULTY', value: 'Easy-Moderate', icon: <Signal size={22} /> },
              { label: 'DISTANCE', value: '22 km (Total)', icon: <Route size={22} /> },
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem', alignItems: 'center' }}>
          <div>
            <h2 style={{ 
              ...
              The Magic of <span style={{ color: currentTheme.text }}>Alpine Meadows</span>
            </h2>
            <p style={{ color: currentTheme.subtext, lineHeight: 1.8, fontSize: '1.1rem', marginBottom: '2rem' }}>
              Dayara Bugyal is among the few treks in India that offers such vast, undulating meadows at 12,000 feet. Whether it's the lush green carpet of summer or the pristine white slopes of winter, Dayara remains a dream destination for beginners and experts alike.
            </p>
            
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              {[
                { title: 'Vast Alpine Meadows', desc: 'Explore one of India\'s largest high-altitude meadows, stretching across 28 square kilometers of breathtaking beauty.', icon: <CheckCircle2 size={20} color="#3d7a4f" /> },
                { title: 'Oak & Rhododendron Trails', desc: 'Trek through ancient forests that come alive with vibrant rhododendrons and golden oak leaves.', icon: <CheckCircle2 size={20} color="#3d7a4f" /> },
                { title: '360° Himalayan Panorama', desc: 'Witness the towering peaks of Bandarpoonch, Black Peak, and the Gangotri range standing tall in the distance.', icon: <CheckCircle2 size={20} color="#3d7a4f" /> },
              ].map(item => (
          ...
          <div style={{ position: 'relative', display: 'flex', gap: '1rem' }}>
            <div style={{ flex: 1, paddingTop: '4rem' }}>
              <img src={dayaraTrek} alt="Dayara Bugyal Forest Path" style={{ width: '100%', borderRadius: '1.5rem', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }} />
            </div>
            <div style={{ flex: 1 }}>
              <img src={dayaraMeadows} alt="Dayara Bugyal Meadows" style={{ width: '100%', borderRadius: '1.5rem', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }} />
            </div>
          </div>
        </div>
      </section>
            ...
            {[
              ...
              <div key={plan.title} style={{ 
                ...
                <div style={{ 
                  ...
                  SPECIAL DISCOUNT FOR STUDENTS & NCC
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{ padding: '2.5rem 1.5rem', background: currentTheme.bg, position: 'relative', overflow: 'hidden' }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          <div style={{ color: '#3d7a4f', fontWeight: 800, fontSize: '0.8rem', letterSpacing: '0.2em', marginBottom: '0.5rem' }}>THE JOURNEY</div>
          <h2 style={{ 
            fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: 900, 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
            {[
              { 
                ...
                desc: 'Pick up from Dehradun Railway Station. A scenic 7-8 hour drive along the Bhagirathi river to reach the traditional base village of Raithal.',
                points: [{ label: 'Drive from Dehradun (180 km)', icon: <Bus size={16} /> }, { label: 'Stay in Raithal Guesthouse', icon: <Tent size={16} /> }],
              ...
              { 
                ...
                desc: 'A gradual 4km ascent through dense oak and rhododendron forests. Reach the beautiful Gui campsite with stunning peak views.',
                points: [{ label: 'Forest Trek (4 km)', icon: <Route size={16} /> }, { label: 'Camp at Gui (9,500 ft)', icon: <Mountain size={16} /> }],
                image: 'https://discoveryhike.in/wp-content/uploads/2025/02/3-1.png',
                reverse: true 
              },
              { 
                day: 'DAY 03', 
                title: 'Gui to Dayara Bugyal', 
                desc: 'Enter the vast alpine meadows of Dayara. Experience the thrill of walking on an endless green/white carpet under the Himalayan sun.',
                points: [{ label: 'Meadow Exploration', icon: <Heart size={16} /> }, { label: 'Himalayan Views', icon: <Sunset size={16} /> }],
                image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=600&q=80',
                reverse: false 
              },
              { 
                day: 'DAY 04', 
                title: 'Bakaria Top Summit', 
                desc: 'Push to the highest point (12,300 ft) for a 360-degree panorama of the Garhwal Himalayas. Descend back to Raithal village.',
                points: [{ label: 'Bakaria Top Summit', icon: <Compass size={16} /> }, { label: 'Descend to Raithal', icon: <ArrowLeft size={16} /> }],
              ...
              { 
                ...
                desc: 'Bid farewell to the mountains as we drive back to Dehradun, carrying home stories of the high meadows.',
                points: [{ label: 'Drive to Dehradun', icon: <Bus size={16} /> }, { label: 'End of Journey', icon: <Award size={16} /> }],
                image: 'https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&w=600&q=80',
                reverse: false 
              },
            ].map((item, idx) => (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '0.9rem', color: currentTheme.subtext, lineHeight: 1.6 }}>
                  Dayara Bugyal is perfect for beginners, but basic fitness helps enjoy the meadows more. We recommend 30 minutes of cardio for 15 days before the trek. Stay hydrated!
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div style={{ background: darkMode ? 'rgba(61,122,79,0.1)' : '#FFF8F0', padding: '2rem', borderRadius: '1.5rem', flex: 1 }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
                {['Transport (Dehradun)', 'Guesthouse Stay', 'Alpine Tents', 'Nutritious Meals', 'Forest Entry Permits', 'Certified Trek Lead'].map(inc => (
                  <span key={inc} style={{ 
            ...
            <div style={{ background: darkMode ? 'rgba(220, 38, 38, 0.1)' : 'rgba(220, 38, 38, 0.05)', padding: '2rem', borderRadius: '1.5rem', flex: 1 }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
                {['Personal porter', 'Mineral water', 'Tips', 'Insurance', 'Meals during travel', 'Anything not in inclusions'].map(exc => (
                  <span key={exc} style={{ 
                    background: '#faf2ee', color: '#333', padding: '6px 14px', 
                    borderRadius: '999px', fontSize: '0.85rem', fontWeight: 600,
                    boxShadow: '0 2px 5px rgba(0,0,0,0.05)'
            ...
            <div style={{ padding: '1.5rem', border: '1px dashed #3d7a4f', borderRadius: '1rem' }}>
              ...
              <p style={{ fontSize: '0.85rem', color: currentTheme.subtext }}>
                🌱 Leave no trace. We follow strict eco-trekking practices. 🚭 No alcohol or smoking on the trail.
              </p>
            </div>
          </div>
        ...
        <div style={{ 
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <h2 style={{ 
              ...
              Meadows are <span style={{ color: '#9dccaa' }}>Calling</span>
            </h2>
            <p style={{ fontSize: '1.25rem', opacity: 0.9, marginBottom: '2.5rem', maxWidth: '600px', margin: '0 auto 2.5rem' }}>
              Experience the tranquility of the high Himalayas. Join us for a journey through the most beautiful meadows in India.
            </p>
